	...
	return (
		<div className="group relative">
			<button
				...
				className="bg-gradient-to-r from-primary-red to-primary-yellow  px-4 py-3 rounded-lg text-sm">
				<Image src="/main/link.svg" alt="Copy-icon" height={25} width={25} />
			</button>
			<div className={`absolute -top-10 ${copied ? "-right-1" : "-right-10"} `}>
