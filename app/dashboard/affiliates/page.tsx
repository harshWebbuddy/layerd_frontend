	...
	return (
		<section className="px-2 sm:px-10 py-5 space-y-5">
			<div className="w-full bg-gradient-to-br from-[#ffffff1f] to-[#8f8f8f0c] backdrop-blur-md rounded-lg p-3 py-7 sm:p-7 space-y-10">
				<div className="flex flex-col sm:flex-row items-start justify-between gap-10 sm:gap-28">
					...
					<div className="w-full flex flex-wrap sm:flex-nowrap gap-4 sm:justify-end">
						{referalLinks.map((item, index) => (
							<Link
								href={item.link}
								key={index}
								className="bg-gradient-to-br from-[#d3d3d309] to-[#8f8f8f00] backdrop-blur-md rounded-lg p-10 space-y-4 flex flex-col items-center w-full sm:w-fit">
								<Image
									src={item.image}
									alt="Referral-image"
									width={55}
