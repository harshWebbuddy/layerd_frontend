...
export default function page() {
	return (
		<section className="px-10 py-5 space-y-5">
			<div className="w-full bg-gradient-to-br from-[#ffffff1f] to-[#8f8f8f0c] backdrop-blur-md rounded-lg p-7 space-y-10">
				<div className="flex items-start justify-between gap-28">
					<div className="w-full space-y-4">
						...
						<div className="space-y-1">
							<p>My Referral URL</p>
							<div className="bg-[#454545] flex items-center justify-between pl-4 rounded-lg">
								<code>https://whopme.com/?ref= DVEX8UDTAQHOODD</code>
					...
					<div className="w-full flex gap-4 justify-end">
						{referalLinks.map((item, index) => (
							<Link
								href={item.link}
								key={index}
								className="bg-gradient-to-br from-[#d3d3d309] to-[#8f8f8f00] backdrop-blur-md rounded-lg p-10 space-y-4 flex flex-col items-center">
								<Image
									src={item.image}
									alt="Referral-image"
									width={55}
				...
				<div className="space-y-4">
					...
					<ol className="list-decimal translate-x-6 space-y-1.5">
