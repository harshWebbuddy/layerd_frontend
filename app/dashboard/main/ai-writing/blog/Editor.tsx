...
export default function Editor({ response }: { response: ResponseBlog }) {
  ...
  const [blog, setBlog] = useState(response?.blog || "");
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="w-full ring-1 ring-white/60 min-h-[400px] mt-5 flex-1 h-full rounded-2xl focus-within:ring-white/80">
          <textarea
            ...
            className="w-full h-full rounded-sm sm:rounded-xl resize-none bg-transparent p-3 sm:p-6 outline-none"
          ></textarea>
        </div>
      </div>
    </div>
