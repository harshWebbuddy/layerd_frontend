	...
	return (
		<div className="h-full">
			<div className="flex flex-col h-full">
						...
						<div className="flex gap-3">
							{formatsList.map((format) => (
								<div
									...
									className={`bg-[#fdbb142b] h-full px-5 grid place-content-center rounded-lg hover:bg-[#fdbb1446] transition cursor-pointer ${
				...
				<div className="w-full ring-1 ring-white/60 mt-5 flex-1 grid place-content-center h-full rounded-2xl">
