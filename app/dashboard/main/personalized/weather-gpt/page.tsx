...
export default function page() {
	return (
		<section className="h-full absolute inset-0">
			<div className="w-[200px] h-[228px] bg-[#FFB076] blur-[150px] absolute top-1/4 left-[-200px] z-[2]" />
			<div className="relative">
				<div className="bg-[url('/main/ai/landscape-background.png')] absolute inset-0 bg-no-repeat h-[500px] bg-center bg-cover">
					<div className="h-96 bg-gradient-to-b from-[#212327] via-[#212327]/80 to-[#21232700] w-full absolute top-0" />
					...
					<div className="h-64 bg-gradient-to-t from-[#212327] via-[#212327]/80 to-[#21232700] w-full absolute bottom-0" />
				</div>
			</div>
			<div className="max-w-6xl mx-auto mt-[300px] relative z-10">
				...
				<div className="flex  flex-col xs:flex-row justify-between gap-6 mt-10 p-3">
