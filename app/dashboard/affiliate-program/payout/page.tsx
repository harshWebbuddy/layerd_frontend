...
export default function page() {
	return (
		<section className="px-10 py-5 space-y-5">
			<div>
				<h1 className="text-3xl font-semibold leading-relaxed">New Payout Request</h1>
				<p className="text-white/70 text-sm">
					Affiliate {">>"} My Payouts {">>"} <span className="text-primary-yellow">New Payout Request</span>
				</p>
			</div>
