		...
		<div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-10 w-full mt-14">
			{products.map((item, index) => (
				<div key={index} className="w-full max-h-[500px] relative">
					...
					/>
					<div className="bg-gradient-to-b from-[#363636] z-10 transform -translate-y-1/2 lg:translate-x-6 shadow-2xl to-[#1F1F1F] rounded-lg min-h-fit sm:min-h-[250px] p-4 pb-10">
