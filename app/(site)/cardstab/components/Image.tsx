      ...
      <div className="w-full max-w-[1220px] 2xl:max-w-[1350px] flex flex-row justify-start brightness-110 relative gap-x-20 items-start mt-2 mb-6 2xl:mt-10 ">
        <div className="w-full  gap-y-4 items-start flex flex-col">
          <div className="2xl:max-w-[603px] w-full brightness-95">
            ...
            >
              <h2 className="text-[#C92544] sm:text-[16px] "> Create Avatar</h2>
              <span className="font-semibold">
              Design Custom Avatars, Effortlessly
              </span>{" "}
            </h1>
            <p
              data-aos="fade-right"
            ...
            >
             Create Avatar is a user-friendly AI tool that allows you to design unique and personalized avatars. Whether you need avatars for social media, gaming, or virtual reality, Create Avatar has you covered. Simply input your desired features, style, and preferences, and the AI will generate a variety of avatar options. <br/><br/>You can customize your avatar's appearance, clothing, and accessories to create a truly personalized digital identity.
            </p>
