      ...
      <div className="w-full max-w-[1220px] 2xl:max-w-[1350px] flex flex-row justify-start brightness-110 relative gap-x-20 items-center mt-2 mb-6 2xl:mt-10 ">
        ...
        <div className="w-full  gap-y-4 items-start flex flex-col">
          <div className="2xl:max-w-[603px] w-full brightness-95">
            ...
            >
              Generate high-quality code snippets and entire functions with just
              a few prompts. Our AI can assist you in writing code for a variety
              of programming languages and frameworks, saving you time and
              effort. From simple scripts to complex algorithms, our AI can
              help you write efficient and reliable code.
            </p>
