          ...
          <div className="2xl:max-w-[603px] w-full brightness-95">
            ...
            >
              <Image
                ...
                height={80}
              />
              <span className="font-semibold">Code Guru</span>{" "}
            </h1>
            <p
              data-aos="fade-right"
              data-aos-duration="1500"
            ...
            >
              <li>
                Get expert advice and guidance on code optimization and best
                practices. Our AI-powered code assistant can identify potential
                performance bottlenecks, suggest improvements, and provide
                explanations for complex code concepts.
              </li>
              <li>
                {" "}
                By learning from your code and providing personalized
                recommendations, our Code Guru can help you write better code.
              </li>
            </p>
