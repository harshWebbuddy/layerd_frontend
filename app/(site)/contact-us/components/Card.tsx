...
export default function Card({ item }: IProps) {
	return (
      ...
      <p className="text-sm text-[#D7D7D7] max-w-xs text-center">{item.description}</p>
			<button className="capitalize bg-gradient-to-r from-primary-red to-primary-yellow py-2 px-4 rounded-lg">
				Talk to us
			</button>
		</div>
	);
