...
export default function Hero() {
	return (
		<div className="mt-[10%] h-fit max-w-[1500px] mx-auto px-2 sm:px-4 min-h-[40vh] max-h-[75vh]">
			...
			<div className="hidden xl:flex justify-center mt-[13%] gap-3 h-[60vh] relative z-10">
